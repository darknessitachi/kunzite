...
public class MarketDataExceptionTest {
    ...
    public void shouldCreateWithMessageAndThrowable() throws Exception {
        MarketDataException uut = new MarketDataException(TEST_MESSAGE, TEST_THROWABLE);
