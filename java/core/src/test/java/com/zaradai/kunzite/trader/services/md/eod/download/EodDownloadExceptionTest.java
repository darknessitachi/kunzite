...
public class EodDownloadExceptionTest {
    ...
    public void shouldCreateWithMessageAndThrowable() throws Exception {
        EodDownloadException uut = new EodDownloadException(TEST_MESSAGE, TEST_THROWABLE);
