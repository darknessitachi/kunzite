...
public class TradingExceptionTest {
    ...
    public void shouldCreateWithMessage() throws Exception {
        TradingException uut = new TradingException(TEST_MESSAGE);
    ...
    public void shouldCreateWithMessageAndCause() throws Exception {
        TradingException uut = new TradingException(TEST_MESSAGE, TEST_CAUSE);
