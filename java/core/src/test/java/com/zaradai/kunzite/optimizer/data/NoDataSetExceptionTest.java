...
public class NoDataSetExceptionTest {
    ...
    public void shouldCreateWithMessageAndThrowable() throws Exception {
        NoDataSetException uut = new NoDataSetException(TEST_MESSAGE, TEST_CAUSE);
